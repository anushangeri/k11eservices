...
<html>
    <head>
		...
		<script>
		    ...
		    $(document).ready(function(){
		      var date_input=$('input[name="joiningDt"]'); //our date input has the name "date"
		      var container=$('.bootstrap-iso form').length>0 ? $('.bootstrap-iso form').parent() : "body";
		      var options={
		        format: 'mm/dd/yyyy',
		        container: container,
		    ...
		    $(document).ready(function(){
		      var date_input=$('input[name="probDtFrm"]'); //our date input has the name "date"
		      var container=$('.bootstrap-iso form').length>0 ? $('.bootstrap-iso form').parent() : "body";
		      var options={
		        format: 'mm/dd/yyyy',
		        container: container,
		    ...
		    $(document).ready(function(){
		      var date_input=$('input[name="probDtTo"]'); //our date input has the name "date"
		      var container=$('.bootstrap-iso form').length>0 ? $('.bootstrap-iso form').parent() : "body";
		      var options={
		        format: 'mm/dd/yyyy',
		        container: container,
